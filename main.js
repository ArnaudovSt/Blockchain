...
const blockchainDetails = new (require("./structs/blockchainDetails"))(blockDifficulty, faucetAddress, faucetBalance, blockReward);

const Block = require("./structs/block");
const Blockchain = [Block.getGenesis(faucetAddress)];

const blockchainService = new (require("./services/blockchain.service"))(Blockchain, blockchainDetails);

const miningService = new (require("./services/mining.service"))(blockchainService, blockchainDetails);

const nodeController = new (require("./controllers/node-controller"))(blockchainService, blockchainDetails, miningService);
